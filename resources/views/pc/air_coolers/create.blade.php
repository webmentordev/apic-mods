        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h2 class="mb-4 text-3xl font-semibold">Add new AIR COOLER</h2>
                    @if (session('success'))
                        <x-success :text="session('success')" />
                    @endif
                    <form action="{{ route('air.cooler') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="w-full mb-3">
                            <x-input-label for="image" :value="__('AIR COOLER Image')" />
