    ...
    <div class="max-w-7xl m-auto">
        <div class="text-center py-[80px]">
            <div class="flex items-center m-auto w-fit mb-6">
                <img src="https://cdn.discordapp.com/attachments/649926592700743681/1198592559744827482/Asset_33x.png" class="max-w-[450px] w-full" alt="APIC ModMode Logo" class="mr-4">
