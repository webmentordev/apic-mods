    ...
    <div class="max-w-[98%] w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('memory.type')">
                                {{ __('Memory Types') }}
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('processor')" :active="request()->routeIs('processor')">
                        {{ __('Processors') }}
                    </x-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('nvme')" :active="request()->routeIs('nvme')">
                        {{ __('NVME') }}
                    </x-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('case')" :active="request()->routeIs('case')">
                        {{ __('Cases') }}
                    </x-nav-link>
                </div>
