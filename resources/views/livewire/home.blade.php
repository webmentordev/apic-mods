<main class="w-full">
    ...
    <section class="w-full px-4 py-[150px] bg-dark-light">
        <div class="max-w-6xl m-auto py-5">
            ...
            <div class="grid grid-cols-2 gap-8 mt-[60px]" data-aos="fade-up">
                <div class="flex items-center">
                    <div class="px-4 py-4">
                        <h3 class="font-bold uppercase text-3xl mb-6 text-white">Professional Builders With World Class Customer Support</h3>
    ...
    <section class="w-full px-4 py-[150px] bg-dark">
        <div class="max-w-6xl m-auto py-5">
            <h2 class="mb-12 bebas text-center text-7xl text-white">WE WORK WITH ONLY BEST BRANDS</h2>
            <img data-aos="fade-up" class="m-auto w-full" src="{{ asset('images/brands.webp') }}" title="Brands Logo" alt="Brands Logo">
